...
def show_protocol_bot():
    """Страница автоматического составления протоколов"""
    st.header("Протокольщик")
    st.info("Загрузите аудиозапись (WAV) или введите текст — система составит протокол по вашей структуре")
